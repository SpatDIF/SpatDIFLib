...
public:
    ...
    void addEventAlias(sdProtoEntity * const entity, std::shared_ptr<sdProtoEvent> event);
...
inline bool sdGlobalEventHandler::removeEventAlias(const sdProtoEntity* const entity, const double &time, const EDescriptor & descriptor ){
...
inline std::vector<std::pair<const sdProtoEntity*, std::shared_ptr<sdProtoEvent>>> sdGlobalEventHandler::getEventsFromAllEntities(const double &time) const{
...
inline std::vector<std::pair<const sdProtoEntity*, std::shared_ptr<sdProtoEvent>>> sdGlobalEventHandler::getEventsFromAllEntities(const double &start, const double &end) const{
...
inline std::vector<std::pair<const sdProtoEntity* , std::shared_ptr<sdProtoEvent>>> sdGlobalEventHandler::getNextEventsFromAllEntities(const double &time) const{
...
inline std::vector<std::pair<const sdProtoEntity* , std::shared_ptr<sdProtoEvent>>> sdGlobalEventHandler::getPreviousEventsFromAllEntities(const double &time) const{
...
inline std::vector<std::pair<const sdProtoEntity* , std::shared_ptr<sdProtoEvent>>> sdGlobalEventHandler::getLastEventsFromAllEntities() const{
    if(allEvents.empty()) return std::vector<std::pair<const sdProtoEntity* , std::shared_ptr<sdProtoEvent>>> ();
    return getEventsFromAllEntities(allEvents.back().second->getTime());
}

inline void sdGlobalEventHandler::addEventAlias(sdProtoEntity * const entity, std::shared_ptr<sdProtoEvent> event){
