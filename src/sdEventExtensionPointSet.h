...
#ifndef ____sdEventExtensionPointSet__
#define ____sdEventExtensionPointSet__

#include "sdEvent.h"
#include "sdDescriptor.h"
/*!
 this class stores event info (i.e. time, descriptor and value) of sdEntityExtensionPointSet.
 */

class sdEventExtensionPointSet: public sdEvent{
    
    /*! only sdEntityExtensionPointSet can make an instance of this class */
...
public:
    ...
    sdEventExtensionPointSet(const double time, const EDescriptor descriptor, void* const value);
    sdEventExtensionPointSet(const std::string time, const std::string descriptor, const std::string value);
    
    /*! destructor destroy all allocated memory to the value pointer*/
    ~sdEventExtensionPointSet();
